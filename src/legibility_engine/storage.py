...
def load_audit_result(path: Path) -> AuditResult:
    ...
    target.setdefault("company_linkedin_url", None)
    target.setdefault("company_substack_url", None)
    target.setdefault("company_medium_url", None)
    target.setdefault("company_youtube_url", None)
    target.setdefault("spokesperson_name", None)
    target.setdefault("spokesperson_linkedin_url", None)
    target.setdefault("spokesperson_substack_url", None)
    target.setdefault("spokesperson_medium_url", None)
    target.setdefault("spokesperson_youtube_url", None)
